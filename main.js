...
function selectRandomWord() {
    ...
    //only allows words which have not been played in the current game
...
function restartGame() {
    inquirer.prompt([{
        ...
        if (confirm == "y") {
            ...
            console.log("");
            console.log("--------------");
            console.log("HANGMAN TIME");
            console.log("--------------");
            console.log("Welcome to the ultimate hangman man game - Overwatch Style Broh!.");
            console.log("Let's Start Guessing!");
            console.log("");
            console.log("Here's your word to guess:");
...
console.log("Let's Start Guessing!");
console.log("");
console.log("Here is your Hero to guess:");
showPlayer.originalDisplay();
console.log("");
console.log("Guesses Left: " + remainingGuesses);
console.log("");
    ...
    if (remainingGuesses > 0) {
        inquirer.prompt([{
            ...
            //if letter is not valid
                ...
                console.log("Please select only a letter from the alphabet!");
                console.log("");
                guessLetters();
            }
        });
        ...
        console.log("The Hero we were looking for was: " + currentWord);
        console.log("");
        console.log("Number of wins: " + wins);
        console.log("Number of losses: " + losses);
        console.log("");
